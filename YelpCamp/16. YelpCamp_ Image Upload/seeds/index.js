...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const newCamp = new Campground({
            ...
            image: [
                {
                  url: 'https://res.cloudinary.com/dshiwsbap/image/upload/v1675886428/YelpCamp/qpo8h1ki1snnws4yyx87.jpg',
                  filename: 'YelpCamp/qpo8h1ki1snnws4yyx87',
                },
                {
                  url: 'https://res.cloudinary.com/dshiwsbap/image/upload/v1675886437/YelpCamp/irp0rbo6c2xhgcv6cvqf.jpg',
                  filename: 'YelpCamp/irp0rbo6c2xhgcv6cvqf',
                }
              ]            
        })
        await newCamp.save()
